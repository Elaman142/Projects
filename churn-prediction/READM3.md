...
- Recall weights more because we're trying to catch the maximun amount of churners on time. 
- Simple model can make excellent performance. 
- Data analysis is critical in the process of building and training the model. 
